...
const TEMPLATES = {
    ...
    social_proof: {
        id: 'social_proof',
        name: '✅ توثيق طلبات الشحن (تم الشحن)',
        icon: 'check-circle',
        description: 'توثيق تسليم وشحن الطلبات الحقيقي (قبل الشحن / بعد الشحن) مع رفع الصور الحقيقية وتعدد الأشكال والمحاكي الرسمي',
        defaultState: {
            bgTheme: 'store',
            bgLighting: 'bright',
            proofStyle: 'stacked', // stacked | cards | full_screenshot | simulator
            proofSource: 'photo', // photo | simulator
            clubName: 'Lyon SC',
            estDate: 'Est. Feb 2019',
            coinsBefore: '274,747',
            coinsAfter: '7,537,797',
            fcPoints: '225',
            amountLoaded: '+7,263,050 كوينز',
            deliveryTime: '4 دقائق',
            platform: 'PlayStation 5',
            customerName: '',
            beforePhotoUrl: 'assets/proof_before_sample.png',
            afterPhotoUrl: 'assets/proof_after_sample.png',
            fullPhotoUrl: 'assets/proof_after_sample.png',
            badgeText: '✅ توثيق تسليم الطلبات الفورية • متجر شوب كوينز',
            headline: 'طلب شحن جديد تم تسليمه بنجاح! 🔒⚡',
            subheadline: 'شحن كوينز آمن 100% بدون أي مخاطر.. ناديك بأيدي أمينة!',
    ...
    flash_sale: {
        ...
        defaultState: {
            ...
            featureTitle: 'مميزات الشوب',
            feature1: 'نشحن الويب اب المقفل (Web App Locked) 🔓',
            feature2: 'سرعة فائقة في التسليم بدون أي انتظار ⚡',
            feature3: 'شحن آمن 100% وضمان شامل لحسابك وناديك 🛡️',
            ...
            headline: 'باقات الكوينز الأقوى لجميع المنصات! 💰🔥',
            subheadline: 'تسليم فوري بدقيقة واحدة • ضمان وأمان كامل للنادي 100% بدون باند 🛡️',
            ctaHeadline: 'للطلب تواصل معنا على الخاص: @shop_coin15 📩',
            ctaSub: '⚡ تسليم فوري • 🛡️ ضمان كامل للنادي • 🔒 أمان 100% بدون باند'
        }
    },
    loaded_accounts: {
        id: 'loaded_accounts',
    ...
    player_review: {
        id: 'player_review',
        name: '⭐ مراجعة وتقييم اللاعبين',
        icon: 'star',
        description: 'مراجعة احترافية شاملة لأداء كروت ونجوم الفوت مع التقييم والإيجابيات والسلبيات وسعر الكوينز',
        defaultState: {
            bgTheme: 'store',
            bgLighting: 'bright',
            ...
            offerText: '💰 كوينز هذا الكرت متوفرة تسليم فوري لناديك بأفضل سعر وبدون انتظار!',
            badgeText: '⭐ مراجعة وتقييم نجوم الفوت • تقرير الخبراء المعتمد',
            headline: 'مراجعة كرت كيليان مبابي: هل يستحق الشراء بالكوينز؟ 🤔🔥',
            subheadline: 'تحليل شامل للأداء، الإيجابيات، السلبيات وحكم الشوب النهائي ⚡',
            ctaHeadline: 'للطلب تواصل معنا على الخاص: @shop_coin15 📩',
            ctaSub: '⚡ تسليم فوري • 🛡️ ضمان كامل للنادي • 🔒 أمان 100% بدون باند'
        }
    },
